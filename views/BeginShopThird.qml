...
Item {
    ...
    Rectangle{
        ...
        color: "#E45F2B"
        Label{
            text: "فرآیند حذف کردن محصول از  سبد خرید"
    ...
    Rectangle{
        ...
        Label{
            id:lbl1
            text: "ابتدا توقف کنید و محصول موردنظر را از سبد بردارید."
    ...
    Rectangle{
        ...
        Label{
            id:lbl2
            text: "پس از نمایش پنجره، بارکد محصول را مقابل
 بارکدخوان بگیرید."
            font.family: viewset.danaFuNumFont
            font.pixelSize: 20
            color: "black"
    ...
    Rectangle{
        ...
        Label{
            id:lbl3
            text: "در صورت اطمینان از حذف محصول، دکمه تایید را بزنید."
            font.family: viewset.danaFuNumFont
            font.pixelSize: 20
            color: "black"
            font.bold: false
    ...
    Image {
        id: imgHelpContainer
        source: "../Assets/HELP/Delete/1.jpg"
        width: 400
        height: 400
        x:58
        y:141
    ...
    Timer {
        ...
        onTriggered:
        {
            ...
            imgHelpContainer.source = "../Assets/HELP/Delete/"+i+".jpg"
