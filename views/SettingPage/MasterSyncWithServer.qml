    ...
    Rectangle {
        ...
        Rectangle{
            ...
            Label{
                ...
                text:tanzimat.settingPage.masterPage.uploadedPercentage + "%"
                font.pixelSize: 25
            ...
            KButton{
                ...
                onClicked: {
                    tanzimat.settingPage.masterPage.startUploadToServer();
                }
            }
        }
        Rectangle{
            ...
            KProgress{
                ...
                x:(parent.width/2) - (width/2)
                from: 0
                to:tanzimat.settingPage.masterPage.tedadToDownload
                value: 0
            ...
            Label{
                anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                text:tanzimat.settingPage.masterPage.tedadDownloaded + " از " + tanzimat.settingPage.masterPage.tedadToDownload
                font.pixelSize: 25
                font.family: viewset.danaFuNumFont
            }
            KButton{
                ...
                anchors.bottomMargin: 10
                onClicked: {
                    tanzimat.settingPage.masterPage.startDownloadFromServer();
                }
            }
        }
    }
